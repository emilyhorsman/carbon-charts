...
export { ChoroplethChartComponent } from './choropleth.component'
export { ExperimentalChoroplethChartComponent } from './experimental-choropleth-chart-component'
...
export { HistogramBinnedChartComponent } from './histogram-binned-chart.component'
